...
export function ErrorNote({ error, onRetry }) {
  return (
    <div className="bg-red-50 border border-red-200 rounded-xl2 p-4 text-[13px] text-red-700 shadow-card">
      ...
      {onRetry && (
        <button
          type="button"
          onClick={onRetry}
          className="mt-3 px-3 py-1.5 rounded-lg bg-white border border-red-300 text-red-700 text-[12.5px] font-medium hover:bg-red-100 transition-default"
        >
          Retry
        </button>
      )}
